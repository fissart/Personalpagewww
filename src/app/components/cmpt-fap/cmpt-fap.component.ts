...
@Component({
  selector: 'app-cmpt-fap',
  templateUrl: './cmpt-fap.component.html',
  styleUrls: ['./cmpt-fap.component.css']
})
export class CmptFapComponent implements OnInit {
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "FAP")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
