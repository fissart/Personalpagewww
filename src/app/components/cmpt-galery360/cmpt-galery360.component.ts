...
@Component({
  selector: 'app-cmpt-galery360',
  templateUrl: './cmpt-galery360.component.html',
  styleUrls: ['./cmpt-galery360.component.css']
})
export class CmptGalery360Component implements OnInit {
  public title!: string;
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "G360")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
