...
@Component({
  selector: 'app-cmpt-promocion',
  templateUrl: './cmpt-promocion.component.html',
  styleUrls: ['./cmpt-promocion.component.css']
})
export class CmptPromocionComponent implements OnInit {
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "PROMOCION")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
