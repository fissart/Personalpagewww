...
@Component({
  selector: 'app-cmpt-store-esfa',
  templateUrl: './cmpt-store-esfa.component.html',
  styleUrls: ['./cmpt-store-esfa.component.css']
})
export class CmptStoreEsfaComponent implements OnInit {
  public title!: string;
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "STORE")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
