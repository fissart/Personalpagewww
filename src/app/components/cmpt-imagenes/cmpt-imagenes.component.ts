...
@Component({
  selector: 'app-cmpt-imagenes',
  templateUrl: './cmpt-imagenes.component.html',
  styleUrls: ['./cmpt-imagenes.component.css']
})
export class CmptImagenesComponent implements OnInit {
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "IMG")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
