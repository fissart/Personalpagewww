...
@Component({
  selector: 'app-cmpt-virtual',
  templateUrl: './cmpt-virtual.component.html',
  styleUrls: ['./cmpt-virtual.component.css']
})
export class CmptVirtualComponent implements OnInit {
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "VIRTUAL")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
