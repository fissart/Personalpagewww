...
const routes: Routes = [
  ...
  { path: 'proyectos', component: Cmpt19EDUCACIONComponent },
  { path: 'Cmpt21APGComponent/:id', component: Cmpt21APGComponent },
  { path: 'sub_proyectos/:id', component: Cmpt20APPComponent },
  { path: 'sub_exposiciones/:id', component: Cmpt22APEComponent },
  { path: 'exposiciones', component: Cmpt23TESISComponent },
  { path: 'Cmpt24BIBLIOTECAComponent', component: Cmpt24BIBLIOTECAComponent },
  { path: 'textos', component: Cmpt25ADMISIONComponent },
